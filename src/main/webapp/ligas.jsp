						...
						<div id="content">
							...
							<!-- Content -->
								...
								<table class="alt">
									...
									ArrayList<Liga>ligas= conexionBD.consultaLigas();
									for(Liga liga: ligas){
										ArrayList<Equipo>equiposLiga=conexionBD.equiposDeUnaLiga(liga.getCod_liga());
										
										out.print("<tr>");
										out.print("<td width='60' rowspan=\"2\"><a href=\"liga.jsp?codLiga="+ liga.getCod_liga() +"\"><img style=\" width: 50px; height: 50px;\" src=\"images/ligas/"+ liga.getCod_liga() +".png\"></a></td>");
										out.print("<td width='300' colspan=\"3\" style=\"padding-left: 15px;\"><a href=\"liga.jsp?codLiga="+ liga.getCod_liga() +"\">"+ liga.getNombre() +"</a></td>");
										for(Equipo equipo: equiposLiga){
											out.print("<td rowspan=\"2\" width='60' style=\"text-align: center;\"><a href=\"equipo.jsp?codEquipo="+ equipo.getCod_equipo() +"\" title=\" " + equipo.getNombre() + " \"  ><img style=\" width: 30px; height: 30px;\" src=\"images/equipos/"+ equipo.getCod_equipo() +".png\"></a></td>	");
										}
										out.print("</tr>");
										out.print("<tr>");
										
										out.print("<td width='50' style=\"text-align: left; padding-left: 14px;\"><img style=\" width: 15px; height: 15px;\" src=\"images/paises/"+ liga.getPais() +".png\"></a></td>");
									...
									%>
										...
										<tr>
											<td width='60' rowspan="2">Escudo_Liga</td>
											<td width='300' colspan="3" style="padding-left: 15px;">Nombre de la Liga</td>
											
											<td rowspan="2" width='60' style="text-align: center;">Escudos de los Equipos de esta Liga</td>	
