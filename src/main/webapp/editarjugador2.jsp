	...
	<div id="page-wrapper">
		...
		<div class="container">
			<div id="content">
				...
				Jugador jugador = conexionBD.consultaJugador(Integer.parseInt(request.getParameter("cod_jugador")));
				%>
				<article> <section class="col-6 col-12-narrower">
				<h3>Editar Jugador</h3>
				<form action="operaciones.jsp?tipo=editarjugador" method="post">
					<div class="row gtr-50">
						<div class="">
							<input type="text" name="cod_jugador" id="cod_jugador"
								maxlength="20" readonly value="<%=jugador.getCod_jugador()%>" />
						</div>
						<div class="">
							<input type="text" name="nombre" id="nombre"
								placeholder="Nombre del jugador" maxlength="9"
								value="<%=jugador.getNombre()%>" />
						</div>
						<div class="">
							<input type="text" name="pierna" id="pierna"
								placeholder="Pierna buena del jugador" maxlength="9"
								value="<%=jugador.getPierna()%>" />
						</div>
						...
						<center>
								...
								<dd>
									<ul>
										...
										<li><a href="#"><img class="flag"
												...
												alt="<%=equipo.getNombre()%>" style="margin-right: 10px;"
												width="25x" height="25px" /><%=equipo.getNombre()%><span
												class="value"><%=equipo.getCod_equipo()%></span></a></li>
							...
							<script type="text/javascript"
								src="customResources/dropEq.js"></script>
						</center>
						<div class="">
							<input type="text" name="pais" id="pais"
								placeholder="País del jugador" maxlength="20"
								value="<%=jugador.getPais()%>" />
						</div>
						<div class="">
							<input type="number" name="altura" id="altura"
								placeholder="Altura del jugador" maxlength="4"
								value="<%=jugador.getAltura()%>" />
						</div>
