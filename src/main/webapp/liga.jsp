					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								Liga liga=conexionBD.consultaLiga(Integer.parseInt(request.getParameter("codLiga"))); %>
								<article>
									<header>
										<h2><%=liga.getNombre()%></h2>
									</header>
								...
								<table class="alt">
									...
									<tbody>
									<%ArrayList<Equipo>equipos= conexionBD.equiposDeUnaLiga(liga.getCod_liga());
									...
									%>
										...
										<tr>
											<td width='60' rowspan="2">
												<a href="equipo.jsp?codEquipo=<%=equipo.getCod_equipo() %>" title="<%=equipo.getNombre()%>"  >
													<img style=" width: 60px;" src="images/equipos/<%=equipo.getCod_equipo()%>.png">
												</a>
											</td>
											...
											<%for(Jugador jugador: jugadoresEq){%>
												<td rowspan="2" width='60' style="text-align: center;">
													<a href="jugador.jsp?codJugador=<%=jugador.getCod_jugador() %>&nombreCarta=SIMPLE" title="<%=jugador.getNombre()%>"  >
														<img style=" width: 40px;" src="images/jugadores/<%=jugador.getCod_jugador()%>.png">
													</a>
												</td>		
											<%}%>
										...
										<tr>
										  ...
										  <td width='50' style="text-align: left; padding-left: 14px;">
										  		<img style=" width: 20px;" src="images/ligas/<%=liga.getCod_liga()%>.png">
										  </td>
										  <td width='50' style="text-align: left; padding-left: 14px;"><img style=" width: 20px;" src="images/paises/<%=liga.getPais()%>.png"></td>
										  <td width='205'></td>
										</tr>
									<%}%>
