							...
							<!-- Content -->
								...
								<form action="operaciones.jsp?tipo=altaequipo" method="post">
									<div class="row gtr-50">
										<div class="">
											<input type="text" name="nombre" id="nombre" placeholder="Nombre del equipo" style="width:450px"; maxlength="30"/>
										</div>
											<select id="cod_liga" name="cod_liga">
												<%
												BDController conexionBD= new BDController();
												ArrayList<Liga>ligas=conexionBD.consultaLigas();
												for (Liga liga: ligas){ %>
												<option style=" transition: border-color 0.2s ease-in-out;
															    background: #fff;
															    ...
															    value="<%=liga.getCod_liga()%>"><%=liga.getNombre()%></option>
												<%}%>
											</select>
