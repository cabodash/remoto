			...
			<div id="content">
				...
				<form action="operaciones.jsp?tipo=editarjugador" method="post">
					<div class="row gtr-50">
						<select id="cod_jugador" name="cod_jugador">
							<%
							...
							%>
							<option
								style="transition: border-color 0.2s ease-in-out; background: #fff; border: solid 1px #2d2c2c; border-radius: 10px; color: lightgrey; display: block; outline: 0; padding: 0.75em; text-decoration: none; width: 100%; font-size: 11pt;"
								value="<%=jugador.getCod_jugador()%>"><%=jugador.getNombre()%></option>
							<%
							}
							%>
						</select> <img alt="" src="images/jugadores/<%=jug.getCod_jugador()%>.png">
						<div class="">
						...
						<select id="cod_equipo" name="cod_equipo">
							<%
							...
							<option
								style="transition: border-color 0.2s ease-in-out; background: #fff; border: solid 1px #2d2c2c; border-radius: 10px; color: lightgrey; display: block; outline: 0; padding: 0.75em; text-decoration: none; width: 100%; font-size: 11pt;"
								value="<%=equipo.getCod_equipo()%>"><%=equipo.getNombre()%></option>
							<%
							}
							%>
						</select>
