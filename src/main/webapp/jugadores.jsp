								...
								<table class="alt">
									...
									<tbody>
										...
										for(Jugador jugador: jugadores){
											...
											Equipo equipo=conexionBD.consultaEquipo(jugador.getCod_equipo());
											Liga liga=conexionBD.consultaLiga(equipo.getCod_liga());
											out.print("<tr>");
											
											out.print("<td width='60' rowspan=\"2\"><a href=\"jugador.jsp?codJugador="+ jugador.getCod_jugador() +"&nombreCarta=SIMPLE\" title=\" " + jugador.getNombre() + " \"  ><img src='images/jugadores/"+ jugador.getCod_jugador() +".png' width=\"70\" height=\"70\"></a></td>");
